...
#include "../../c-utility/inc/azure_c_shared_utility/threadapi.h"
#include "../../c-utility/inc/azure_c_shared_utility/lock.h"
#include "../../c-utility/inc/azure_c_shared_utility/xlogging.h"
#include "../../c-utility/inc/azure_c_shared_utility/singlylinkedlist.h"
#include "../../c-utility/inc/azure_c_shared_utility/vector.h"
#ifdef USE_PROV_MODULE
#include "../inc/iothub_client_hsm_ll.h"
#endif
...
#ifndef DONT_USE_UPLOADTOBLOB
static void FreeBlobSavedData(UPLOADTOBLOB_SAVED_DATA *savedData)
{
    if (savedData == NULL)
    {
        return;
    ...
    if (savedData->destinationFileName != NULL)
    {
...
IOTHUB_CLIENT_RESULT IoTHubClient_UploadToBlobAsync(IOTHUB_CLIENT_HANDLE iotHubClientHandle, const char* destinationFileName, const unsigned char* source, size_t size, IOTHUB_CLIENT_FILE_UPLOAD_CALLBACK iotHubClientFileUploadCallback, void* context)
{
   IOTHUB_CLIENT_RESULT result;
    ...
    else
    {
        ...
        UPLOADTOBLOB_SAVED_DATA *savedData = (UPLOADTOBLOB_SAVED_DATA *)calloc(1, sizeof(UPLOADTOBLOB_SAVED_DATA));
        if (savedData == NULL)
        {
